  ...
  const messages = [
    {
      role: 'system',
      content:
        'You are an academic schedule review assistant. Return strict JSON only. Do not use markdown. Do not wrap the JSON in code fences. Base your answer only on the provided schedule context. Keep advice practical and concise.',
    },
    {
      role: 'user',
