...
const BASE_COURSES: CourseBlueprint[] = [
  { code: '11102', name: 'Introduction to Computer Science', department: 'Computer Science', type: 'theoretical', isPlannable: false, credits: 3, prerequisites: [], concurrentCourses: [], minimumCompletedCredits: undefined, internetDifficulty: 24, difficultyBasis: 'Introductory CS survey course tracked in the transcript catalog.' },
  { code: '11151', name: 'Structured Programming Lab', department: 'Computer Science', type: 'practical', isPlannable: false, credits: 1, prerequisites: [], concurrentCourses: ['11103'], minimumCompletedCredits: undefined, internetDifficulty: 26, difficultyBasis: 'Foundational programming lab tracked in the transcript catalog.' },
