...
export default function AdvisorMessagesPage() {
  ...
  const handleSend = () => {
    ...
    const result = sendMessage({ senderId: advisorId, recipientId: activeStudentId, body: draft });
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                {feedback ? <p className="text-sm text-gray-600">{feedback}</p> : <p className="text-sm text-gray-500">Use messaging to follow up on schedule risk and registration choices.</p>}
                <button
                  onClick={handleSend}
