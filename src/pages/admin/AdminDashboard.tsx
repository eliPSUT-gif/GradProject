    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
        {kpis.map((item) => {
          ...
          return (
            <div key={item.label} className="relative overflow-hidden rounded-full border border-gray-200 bg-white px-5 py-4 shadow-sm transition-shadow hover:shadow-md">
