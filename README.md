...
The production reCAPTCHA site key must allow `psut.site` and `www.psut.site` in the Google reCAPTCHA admin console. Otherwise the browser script will fail with an invalid-domain error before the server verification endpoint is reached.
